...
var starters = menuItems.filter(function (e) {
  return e.type == "starters";
});
var pizza = menuItems.filter(function (e) {
  return e.type == "pizza";
});
var pasta = menuItems.filter(function (e) {
  return e.type == "pasta";
});
var spicyscheck = document.getElementById("check");
spicyscheck.addEventListener("click", checkboxspice);

function checkboxspice() {
  var allspicy = document.querySelectorAll(".icons");

  if (document.querySelector('#check:checked') !== null) {
    //turning spice on
    console.log("not check");
    allspicy.forEach(function (e) {
      e.hidden = false;
    });
  } else {
    allspicy.forEach(function (e) {
...
function listingTemplate(group, e) {
  var liststarter = document.createElement('li');
  var price = document.createElement("span");
  price.className = "price";
  var title = document.createElement('h3');
  title.className = "title";
  var subtitle = document.createElement("div");
  var spicy = document.createElement("i");
  ...
  title.appendChild(price); //subtitle

  subtitle.appendChild(document.createTextNode(e.description + " "));
  subtitle.appendChild(spicy); //append to list now
...
function renderstarters() {
  var getstarters = document.getElementById('starters');
  var group = document.createElement('ul');
  starters.forEach(function (e) {
...
function renderpasta() {
  var getpasta = document.getElementById('pasta');
  var group = document.createElement('ul');
  pasta.forEach(function (e) {
    listingTemplate(group, e);
  });
